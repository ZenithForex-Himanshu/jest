            ...
            <Row>
                <Col>
                    <Form.Group className="mb-3 col-12">
                        ...
                        <Form.Control onChange={(e) => setFname(e.target.value)} value={fname} type="fname" placeholder="Enter first name" id='fname' />
                    </Form.Group>
                </Col>
                <Col>
                    <Form.Group className="mb-3 col-12">
                        <Form.Label htmlFor="lname">Last Name</Form.Label>
                        <Form.Control onChange={(e) => setLname(e.target.value)} value={lname} type="lname" placeholder="Enter last name" id='lname' />
                    </Form.Group>
                </Col>
                <Col>
                    <Form.Group className="mb-3 col-12">
                        <Form.Label htmlFor="email">Email</Form.Label>
                        <Form.Control id="email" onChange={(e) => setEmail(e.target.value)} value={email} type="email" placeholder="Enter email" />
                    </Form.Group>
                </Col>
            </Row>
            <Row>
                <Col></Col>
                <Col>
                    <Button onClick={() => addEmployee(fname, lname, email)}>Submit</Button>
                </Col>
            </Row>
            <Row>&nbsp;</Row>
